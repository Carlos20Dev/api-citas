    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          pool = _context3.sent;
          _context3.next = 6;
          return pool.request().input('Id', id_medico).query("SELECT h.id_horario, h.fecha, h.hora_inicio, h.hora_fin, rt.id_rt, rt.num_pacientes FROM reg_turno rt JOIN horario h ON rt.id_horario = h.id_horario WHERE rt.id_medico = @Id");
        case 6:
